...
try:
    ...
    logger.info(
        "Ollama configured successfully | keep_alive=30m | "
        "num_predict=40"
    )
...
try:
    agri_assistant = Agent(
        ...
        # and place it into the model context.
        add_knowledge_to_context=True,

        # Do not expose knowledge search as an
        # additional model-callable tool.
...
logger.info(
    "Ollama LLM enabled | keep_alive=30m | num_predict=40"
)
